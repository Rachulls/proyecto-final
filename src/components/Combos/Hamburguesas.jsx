...
const datos = {
  ...
  rows: [
    ...
    {
      title:
        "¿Las hamburguesas delivery de Bembos están acompañadas de papas fritas?",
      content:
    ...
    {
      title:
        "¿Qué adicionales tienen las hamburguesas a la parrilla de Bembos?",
      content:
    ...
    <>
      ...
      <CombosDeHamburguesasMainContainer>
        <HamburguesasGridContainer>
          {data.hamburguesas.map((item) => (
            <Card>
              ...
              <ContentContainer>
                <h3 style={{ fontSize: "1.4rem", fontWeight: "100" }}>
                  {item.nombre}
                </h3>
        ...
        <PreguntasContainer style={{ flexDirection: "column" }}>
          <Titulo>HAMBURGUESAS A LA PARRILLA</Titulo>
          <p style={{ lineHeight: "25px", color: "black" }}>
            Sabemos que la preparación de la carne de una hamburguesa es una de
            las partes más importantes. Por ello, Bembos te ofrece una técnica
            de cocción única en la que la mantenemos suspendida sobre el fuego
            para otorgarle la jugosidad perfecta que nos caracteriza. Combina tu
            hamburguesa de carne a la parrilla con los mejores ingredientes que
            hemos elegido para ti: tocino, plátano, tomate, lechuga, huevo,
            queso y mucho más. ¡No esperes más y empieza a disfrutar de lo mejor
            del sabor peruano!
          </p>
        </PreguntasContainer>
